    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-8">
            <div class="flex items-center">
                ...
                <h1 class="text-3xl font-bold text-gray-900">Modifier un utilisateur</h1>
            </div>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="role" id="role" required
                                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                            <option value="Radmin" {{ $user->role == 'Radmin' ? 'selected' : '' }}>Administrateur</option>
                            <option value="Rbibliothecaire" {{ $user->role == 'Rbibliothecaire' ? 'selected' : '' }}>Bibliothécaire</option>
                            <option value="Rlecteur" {{ $user->role == 'Rlecteur' ? 'selected' : '' }}>Lecteur</option>
                        </select>
                        @error('role')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="md:col-span-2">
                        <div class="flex items-center">
                            <input type="checkbox" name="actif" id="actif" value="1" {{ $user->actif ? 'checked' : '' }}
